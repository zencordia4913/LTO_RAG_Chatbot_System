#!/home/jeryl4913/lto_rag_reviewer/LTO_RAG/bin/python
...
def load_onsets(onsets_files, args):
    ...
    for i, fid in enumerate(onsets_files):
        ...
        if args.onset_col or args.duration_col or args.condition_col or args.pmods_col:
...
def parse_args():
    ...
    parser.add_argument("--out", "-o", default="onsets_", help="Output filename.")
    parser.add_argument(
    ...
    parser.add_argument(
        "--pmod-name",
        default="pmod",
        help="Name to use when writing FSL Amplitude as SPM " "parametric modulator",
    )
    ...
    parser.add_argument(
        "--drop-cols", help="Drop pre-named columns in" "longform", default=True
    )
